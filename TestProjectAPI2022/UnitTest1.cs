...
namespace TestProjectAPI2022
{
    ...
    public class UnitTest1
    {
        ...
        {
            var result = ChamaApiPost("https://localhost:7033/api/List").Result;
        ...
        public void GetToken()
        {
            ...
            string urlApiGeraToken = "https://localhost:7033/api/CriarTokenIdentity";

            using (var cliente = new HttpClient())
            {
                string login = "paulostevo@gmail.com";
                string senha = "!Psgdn0701@";
                var dados = new
                {
                    email = login,
                    senha = senha,
